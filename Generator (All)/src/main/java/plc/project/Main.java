...
//        repl(Main::evaluator);
    ...
    private static void generator(String input) throws LexException, ParseException, EvaluateException, AnalyzeException {
        var ast = new Parser(new Lexer(input).lex()).parseSource(); //edit for manual testing

//        var rt = EVALUATOR.visit(ast);  // For testing exceptions
